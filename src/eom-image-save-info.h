...
#define EOM_IMAGE_SAVE_INFO(o) \
  (G_TYPE_CHECK_INSTANCE_CAST((o), EOM_TYPE_IMAGE_SAVE_INFO, EomImageSaveInfo))
#define EOM_IMAGE_SAVE_INFO_CLASS(k)                      \
  (G_TYPE_CHECK_CLASS_CAST((k), EOM_TYPE_IMAGE_SAVE_INFO, \
                           EomImageSaveInfoClass))
#define EOM_IS_IMAGE_SAVE_INFO(o) \
  (G_TYPE_CHECK_INSTANCE_TYPE((o), EOM_TYPE_IMAGE_SAVE_INFO))
#define EOM_IS_IMAGE_SAVE_INFO_CLASS(k) \
  (G_TYPE_CHECK_CLASS_TYPE((k), EOM_TYPE_IMAGE_SAVE_INFO))
#define EOM_IMAGE_SAVE_INFO_GET_CLASS(o)                    \
  (G_TYPE_INSTANCE_GET_CLASS((o), EOM_TYPE_IMAGE_SAVE_INFO, \
                             EomImageSaveInfoClass))
