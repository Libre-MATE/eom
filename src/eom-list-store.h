...
#define EOM_LIST_STORE(obj) \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), EOM_TYPE_LIST_STORE, EomListStore))
#define EOM_LIST_STORE_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_CAST((klass), EOM_TYPE_LIST_STORE, EomListStoreClass))
#define EOM_IS_LIST_STORE(obj) \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), EOM_TYPE_LIST_STORE))
#define EOM_IS_LIST_STORE_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_TYPE((klass), EOM_TYPE_LIST_STORE))
#define EOM_LIST_STORE_GET_CLASS(obj) \
  (G_TYPE_INSTANCE_GET_CLASS((obj), EOM_TYPE_LIST_STORE, EomListStoreClass))
