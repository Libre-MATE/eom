...
#define EOM_TRANSFORM(o) \
  (G_TYPE_CHECK_INSTANCE_CAST((o), EOM_TYPE_TRANSFORM, EomTransform))
#define EOM_TRANSFORM_CLASS(k) \
  (G_TYPE_CHECK_CLASS_CAST((k), EOM_TYPE_TRANSFORM, EomTransformClass))
#define EOM_IS_TRANSFORM(o) \
  (G_TYPE_CHECK_INSTANCE_TYPE((o), EOM_TYPE_TRANSFORM))
#define EOM_IS_TRANSFORM_CLASS(k) \
  (G_TYPE_CHECK_CLASS_TYPE((k), EOM_TYPE_TRANSFORM))
#define EOM_TRANSFORM_GET_CLASS(o) \
  (G_TYPE_INSTANCE_GET_CLASS((o), EOM_TYPE_TRANSFORM, EomTransformClass))
