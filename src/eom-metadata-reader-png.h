...
#define EOM_METADATA_READER_PNG(o)                               \
  (G_TYPE_CHECK_INSTANCE_CAST((o), EOM_TYPE_METADATA_READER_PNG, \
                              EomMetadataReaderPng))
#define EOM_METADATA_READER_PNG_CLASS(k)                      \
  (G_TYPE_CHECK_CLASS_CAST((k), EOM_TYPE_METADATA_READER_PNG, \
                           EomMetadataReaderPngClass))
#define EOM_IS_METADATA_READER_PNG(o) \
  (G_TYPE_CHECK_INSTANCE_TYPE((o), EOM_TYPE_METADATA_READER_PNG))
#define EOM_IS_METADATA_READER_PNG_CLASS(k) \
  (G_TYPE_CHECK_CLASS_TYPE((k), EOM_TYPE_METADATA_READER_PNG))
#define EOM_METADATA_READER_PNG_GET_CLASS(o)                    \
  (G_TYPE_INSTANCE_GET_CLASS((o), EOM_TYPE_METADATA_READER_PNG, \
                             EomMetadataReaderPngClass))
