...
#define EOM_URI_CONVERTER(o) \
  (G_TYPE_CHECK_INSTANCE_CAST((o), EOM_TYPE_URI_CONVERTER, EomURIConverter))
#define EOM_URI_CONVERTER_CLASS(k) \
  (G_TYPE_CHECK_CLASS_CAST((k), EOM_TYPE_URI_CONVERTER, EomURIConverterClass))
#define EOM_IS_URI_CONVERTER(o) \
  (G_TYPE_CHECK_INSTANCE_TYPE((o), EOM_TYPE_URI_CONVERTER))
#define EOM_IS_URI_CONVERTER_CLASS(k) \
  (G_TYPE_CHECK_CLASS_TYPE((k), EOM_TYPE_URI_CONVERTER))
#define EOM_URI_CONVERTER_GET_CLASS(o) \
  (G_TYPE_INSTANCE_GET_CLASS((o), EOM_TYPE_URI_CONVERTER, EomURIConverterClass))
...
G_GNUC_INTERNAL
gboolean eom_uri_converter_do(EomURIConverter *converter, EomImage *image,
