...
#define EOM_SCROLL_VIEW(obj) \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), EOM_TYPE_SCROLL_VIEW, EomScrollView))
#define EOM_SCROLL_VIEW_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_CAST((klass), EOM_TYPE_SCROLL_VIEW, EomScrollViewClass))
#define EOM_IS_SCROLL_VIEW(obj) \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), EOM_TYPE_SCROLL_VIEW))
#define EOM_IS_SCROLL_VIEW_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_TYPE((klass), EOM_TYPE_SCROLL_VIEW))
