...
#define EOM_PRINT_IMAGE_SETUP(obj)                               \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), EOM_TYPE_PRINT_IMAGE_SETUP, \
                              EomPrintImageSetup))
#define EOM_PRINT_IMAGE_SETUP_CLASS(klass)                      \
  (G_TYPE_CHECK_CLASS_CAST((klass), EOM_TYPE_PRINT_IMAGE_SETUP, \
                           EomPrintImageSetupClass))
#define EOM_IS_PRINT_IMAGE_SETUP(obj) \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), EOM_TYPE_PRINT_IMAGE_SETUP))
#define EOM_IS_PRINT_IMAGE_SETUP_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_TYPE((klass), EOM_TYPE_PRINT_IMAGE_SETUP))
#define EOM_PRINT_IMAGE_SETUP_GET_CLASS(obj)                    \
  (G_TYPE_INSTANCE_GET_CLASS((obj), EOM_TYPE_PRINT_IMAGE_SETUP, \
                             EomPrintImageSetupClass))
