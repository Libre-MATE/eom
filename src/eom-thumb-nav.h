...
#define EOM_THUMB_NAV(obj) \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), EOM_TYPE_THUMB_NAV, EomThumbNav))
#define EOM_THUMB_NAV_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_CAST((klass), EOM_TYPE_THUMB_NAV, EomThumbNavClass))
#define EOM_IS_THUMB_NAV(obj) \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), EOM_TYPE_THUMB_NAV))
#define EOM_IS_THUMB_NAV_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_TYPE((klass), EOM_TYPE_THUMB_NAV))
#define EOM_THUMB_NAV_GET_CLASS(obj) \
  (G_TYPE_INSTANCE_GET_CLASS((obj), EOM_TYPE_THUMB_NAV, EomThumbNavClass))
