...
#define EOM_THUMB_VIEW(obj) \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), EOM_TYPE_THUMB_VIEW, EomThumbView))
#define EOM_THUMB_VIEW_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_CAST((klass), EOM_TYPE_THUMB_VIEW, EomThumbViewClass))
#define EOM_IS_THUMB_VIEW(obj) \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), EOM_TYPE_THUMB_VIEW))
#define EOM_IS_THUMB_VIEW_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_TYPE((klass), EOM_TYPE_THUMB_VIEW))
#define EOM_THUMB_VIEW_GET_CLASS(obj) \
  (G_TYPE_INSTANCE_GET_CLASS((obj), EOM_TYPE_THUMB_VIEW, EomThumbViewClass))
...
void eom_thumb_view_set_thumbnail_popup(EomThumbView *thumbview, GtkMenu *menu);
