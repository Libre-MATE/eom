...
#define EOM_CLIPBOARD_HANDLER(o)                               \
  (G_TYPE_CHECK_INSTANCE_CAST((o), EOM_TYPE_CLIPBOARD_HANDLER, \
                              EomClipboardHandler))
#define EOM_CLIPBOARD_HANDLER_CLASS(k)                      \
  (G_TYPE_CHECK_CLASS_CAST((k), EOM_TYPE_CLIPBOARD_HANDLER, \
                           EomClipboardHandlerClass))
#define EOM_IS_CLIPBOARD_HANDLER(o) \
  (G_TYPE_CHECK_INSTANCE_TYPE((o), EOM_TYPE_CLIPBOARD_HANDLER))
#define EOM_IS_CLIPBOARD_HANDLER_CLASS(k) \
  (G_TYPE_CHECK_CLASS_TYPE((k), EOM_TYPE_CLIPBOARD_HANDLER))
#define EOM_CLIPBOARD_HANDLER_GET_CLASS(o)                    \
  (G_TYPE_INSTANCE_GET_CLASS((o), EOM_TYPE_CLIPBOARD_HANDLER, \
                             EomClipboardHandlerClass))
